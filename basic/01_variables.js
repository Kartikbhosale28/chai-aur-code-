...
/* scope means ={} that means if one programmer has set the value of account_Password in one code and another programmer is
   using the another code and if he/she uses account_Password variable and changes the vlaue or sets the other value it gets reflected  in the first programmers code as well.... therefore we dont use var 
